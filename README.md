#       Notas em computação e comunicação quântica
...
<!--
>   ##  [**Algoritmos quânticos**](2.algoritmos-quanticos/README.md)
>
>   Fazendo-se valer das vantagens do paradigma quântico de computação, a exemplo de seu paralelismo natural, alguns algoritmos foram propostos. Neste capítulo, iremos nos aprofundar em tais algoritmos, como os famosos algoritmo quântico de busca proposto pro Groover e o algoritmo de Shor para fatoração de números em fatores primos.
-->
